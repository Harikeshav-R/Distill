...
class PromptCompressor:
    ...
    def load_model(
        ...
        config = AutoConfig.from_pretrained(model_name, token="", **model_config)
        tokenizer = AutoTokenizer.from_pretrained(model_name, token="", **model_config)
    ...
    def compress_prompt(
        ...
        context_segs = None
        context_segs_rate = None
        context_segs_compress = None
